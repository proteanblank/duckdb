...
//                         DuckDB
//
// duckdb/storage/segment/rle_segment.hpp
//
//
//===----------------------------------------------------------------------===//
...
class RLESegment : public UncompressedSegment {
public:
	RLESegment(BufferManager &manager, TypeId type, idx_t row_start, block_id_t block_id = INVALID_BLOCK);
